...
public record CreateAttachmentCommand(
        ...
        @Parameter(
                ...
                example = "첨부파일",
                required = true,
                schema = @Schema(description = "이름", implementation = String.class)
        )
        ...
        @Parameter(
                ...
                required = true,
                schema = @Schema(description = "경로명", implementation = String.class)
        )
        ...
        @Parameter(
                ...
                required = true,
                schema = @Schema(description = "MIME 타입", implementation = String.class)
        )
        ...
        @Parameter(
                ...
                example = "1024",
                required = true,
                schema = @Schema(description = "크기", implementation = Long.class)
        )
